...
public interface SolidityVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitUsingForObject(SolidityParser.UsingForObjectContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#usingForObjectDirective}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUsingForObjectDirective(SolidityParser.UsingForObjectDirectiveContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#userDefinableOperators}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUserDefinableOperators(SolidityParser.UserDefinableOperatorsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMappingKeyName(SolidityParser.MappingKeyNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link SolidityParser#mappingValueName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMappingValueName(SolidityParser.MappingValueNameContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitInlineAssemblyStatementFlag(SolidityParser.InlineAssemblyStatementFlagContext ctx);
	/**
